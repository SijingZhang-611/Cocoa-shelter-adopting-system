...
public class ShapeTest {
  ...
  public void testObjectData() {
    Assert.assertEquals("Circle: center (3.000,4.000) radius 5.000",circle1.toString
            ());
    Assert.assertEquals("Circle: center (10.320,10.430) radius 10.000",circle2.toString
            ());
    Assert.assertEquals("Circle: center (0.000,0.000) radius 20.000",circle3
            .toString
            ());
    Assert.assertEquals("Rectangle: LL corner (5.000,6.000) width 2.500 height 2.000",
            rect1.toString());
    Assert.assertEquals("Rectangle: LL corner (2.000,3.000) width 10.000 height 10" +
            ".000",rect2
            .toString());
  }
  ...
  public void testArea() {
    Assert.assertEquals(Math.PI*25,circle1.area(),0.001);
    Assert.assertEquals(Math.PI*100,circle2.area(),0.001);
    Assert.assertEquals(Math.PI*400,circle3.area(),0.001);
    Assert.assertEquals(5,rect1.area(),0.001);
    Assert.assertEquals(100,rect2.area(),0.001);
  }
  ...
  public void testResizes() {
    ...
    Assert.assertEquals(2.5*circle1.area(),resizedCircle1.area(),0.001);
    Assert.assertEquals(0*circle2.area(),resizedCircle2.area(),0.001);
    Assert.assertEquals(10*circle3.area(),resizedCircle3.area(),0.001);
    Assert.assertEquals(12.5*rect1.area(),resizedRect1.area(),0.001);
    Assert.assertEquals(0.001*rect2.area(),resizedRect2.area(),0.001);
  }
