...
public interface TTTModel {
  ...
  /**
   *
   * The board is represented as a 2D array of Player objects, where each element
   * represents a cell on the board. The state of each cell can be occupied by a
   * Player or be empty.
   *
   * Design Decision :get the current board status.
   *
   * @return A 2D array of Player objects representing the current board state.
   */
